...
I could now write down all my grades and assign them as I did in the first chapter, but there is a way to automate this process.
...
When would you need loops?
When you apply an operation to multiple columns of your dataset one after the other (like obtain the mean of every column), or when adding elements to your plot as follows:
...
Since you will eventually encounter them, I will shortly show you nested loops, although they are not super common (because most R functions are vectorized):
...
-   Afterwards, you write down the command with the `function()` command. Put your variables into the parentheses. Later your input follows those variables.
...
To further develop your R Skills, check out the two courses from Okan and Lion that we mentioned at the beginning and the course.
...
-   [Hertie School Data Science Summer School](https://www.youtube.com/@datasciencelab.berlin/playlists): Amazing tutorials in English from a top German University.
    The tutorials cover topics from introduction to R, visualizing data in R, to more advanced topics like webscraping with R.
    You can work on many skills and application of R once you are comfortable with the basics.
    You can freely watch the full tutorials on Youtube but also access the course materials [here](https://ds3.ai/summerschool), [here](https://ds3.ai/) and [here](https://ds3.ai/2022).
